...
class Advanced:
    ...
    def execute_script(self, sql_script, commands=None, split_algo=True, dump_fails=True, execute_fails=True):
    ...
    def script(self, sql_script, split_algo=True, dump_fails=True):
